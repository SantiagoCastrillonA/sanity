...
export const RegisterPage = () => {
    ...
    return (
        <div class="bg-gradient-to-b from-bg-secondary from-1% via-bg-primary via-20% to-bg-secondary to-100% h-lvh justify-center items-center flex text-center p-4">
            <div>
